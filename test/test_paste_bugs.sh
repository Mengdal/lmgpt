#!/usr/bin/env bash
# ============================================================================
# Test: lmgpt paste handling verification
...
echo "=== lmgpt Paste Bug Verification ==="
echo ""
...
# Exact replica of lmgpt escape parser (lines 2232-2249)
_escape_parser() {
    local seq="" ch
    local input="$1"
    local i
