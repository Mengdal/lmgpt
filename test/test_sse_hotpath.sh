...
# Validates B1/B2/B3/B4/B5 implementations before applying to lmgpt.
...
# ===================================================================
# ANSI globals (mirror lmgpt Section 1)
# ===================================================================
...
# Inline sed version for comparison (exact same as lmgpt L7987-8001)
